...
constexpr auto raw_device_count_response = std::to_array<uint8_t>(
...
constexpr auto raw_unknown_device_1_response = std::to_array<uint8_t>(
...
constexpr auto raw_unknown_device_2_response = std::to_array<uint8_t>(
...
constexpr auto raw_unknown_device_3_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46,
...
constexpr auto raw_null_device_1_response = std::to_array<uint8_t>(
...
constexpr auto raw_null_device_2_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
     0x16, 0xff, 0x00, 0x01, 0x00, 0x00, 0x00, 0x04, 0xff, 0x01, 0x03, 0x00,
     0x00, 0x00, 0x00, 0xff, 0x00, 0x00, 0x00, 0x00, 0xff, 0x19, 0x5b});

constexpr auto raw_barometer_device_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_pico_internal_device_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_st107_voltage_device_2_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_st107_voltage_device_3_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_st107_resistive_device_1_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_st107_resistive_device_2_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_st107_resistive_device_3_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_st107_resistive_device_4_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_unknown_device_4_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_sc303_current_device_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_sc303_voltage_device_1_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_sc303_voltage_device_2_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_sc303_resistive_device_1_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_sc303_resistive_device_2_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_sc303_resistive_device_3_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_battery_device_1_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x01,
...
constexpr auto raw_temperature_device_1_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_tank_device_1_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x01,
...
constexpr auto raw_battery_device_2_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x01,
...
constexpr auto raw_tank_device_2_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x01,
...
constexpr auto raw_temperature_device_2_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_temperature_device_3_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto raw_temperature_device_4_response = std::to_array<uint8_t>(
    {0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0x41, 0x85, 0xde, 0xc3, 0x46, 0x00,
...
constexpr auto make_raw_device_info_response() noexcept {
  using std::ranges::to;
...
constexpr auto make_raw_state_response() noexcept {
